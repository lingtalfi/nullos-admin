...
class LayoutBridgeDisplayToolsLeftMenuLinksOperation extends MethodArrayTransformer implements OperationInterface
{
    ...
    {
        $this->replaceByMethod($report, LayoutBridge::class, 'displayToolsLeftMenuLinks');
    }
