...
class LayoutBridgeDisplayLeftMenuBlocksOperation extends MethodArrayTransformer implements OperationInterface
{
    ...
    {
        $this->replaceByMethod($report, LayoutBridge::class, 'displayLeftMenuBlocks');
    }
